-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('ADMIN', 'CUSTOMER_SUPPORT', 'USER', 'SUPER_ADMIN');

-- CreateEnum
CREATE TYPE "PermissionName" AS ENUM ('MANAGE_PRODUCTS', 'VIEW_ORDERS', 'MANAGE_USERS', 'PROCESS_PAYMENTS', 'MANAGE_SHIPPING');
